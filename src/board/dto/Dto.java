...
public class Dto {
    ...
    private int bHit;
    private int bGroup; // 기존 글의 종속된 답변을 확인하기 위한 id
    private int bStep; // 기존 글 대비 얼마나 아래 쪽에 답변을 배치할 것인지를 확인
    private int bIndent; // 기존 글 대비 얼마나 들여써서 답변을 배치할 것인지를 확인

    // Constructor
    public Dto (String userId, int bId, String bName, String bTitle, String bContent, Timestamp bDate, int bHit, int bGroup, int bStep, int bIndent) {
        this.userId = userId;
        this.bId = bId;
        this.bName = bName;
        this.bTitle = bTitle;
