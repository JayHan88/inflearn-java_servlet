...
<% if(session.getAttribute("ValidMember") == "yes") { %>
    <jsp:forward page="/Board/Main.jsp"></jsp:forward>
<% } %>
...
<body>
    <form action="/Board/LoginCheck.jsp" method="post">
        </br>
        ...
        <input type="submit" value="로그인"> &nbsp;&nbsp; <input type="button" value="회원가입" onclick="window.location='/Board/Join.jsp'">
    </form>
</body>
</html>
