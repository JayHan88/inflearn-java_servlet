...
<jsp:useBean id="dto" class="board.dto.MemberDto" />
...
<body>
    ...
    <form action="/Board/ModifyCheck.jsp" method="post" name="modi_form">
        아이디 : <%= id %> </br></br>
        ...
        <input type="button" value="수정하기" onclick="updateInfoConfirm()"> &nbsp;&nbsp;&nbsp; <input type="reset" value="돌아가기" onclick="window.location='/Board/Login.jsp'">
    </form>
</body>
</html>
